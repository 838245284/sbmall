...
public class GameSoundPool {
    ...
    public GameSoundPool() {
        ...
        mSparseIntArray.put(GAME_SOUND_BET_START, mSoundPool.load(CommonAppContext.sInstance, R.raw.game_bet_start, 1));
        mSparseIntArray.put(GAME_SOUND_BET_CHOOSE, mSoundPool.load(CommonAppContext.sInstance, R.raw.game_bet_choose, 1));
        mSparseIntArray.put(GAME_SOUND_BET_SUCCESS, mSoundPool.load(CommonAppContext.sInstance, R.raw.game_bet_success, 1));
        mSparseIntArray.put(GAME_SOUND_RESULT, mSoundPool.load(CommonAppContext.sInstance, R.raw.game_show_result, 1));
    }
