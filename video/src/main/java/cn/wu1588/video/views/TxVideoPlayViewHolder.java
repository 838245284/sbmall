...
public class TxVideoPlayViewHolder extends AbsViewHolder implements ITXVodPlayListener, View.OnClickListener {
    ...
    public TxVideoPlayViewHolder(Context context, ViewGroup parentView) {
