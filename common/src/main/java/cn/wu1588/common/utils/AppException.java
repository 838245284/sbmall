...
//        if (PermissionsUtils.checkPermissions(mContext, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE})) {
//            Logger.e("权限通过");
//        } else {
//            Logger.e("没有权限，保存日志失败");
//            return sb.toString();
//        }
//        try {
//            long timestamp = System.currentTimeMillis();
//            String time = formatter.format(new Date());
//            String fileName = "海兔异常log-" + time + "-" + timestamp + ".log";
